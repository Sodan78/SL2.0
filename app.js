...
const tools = [
  ...
  },
  {
    ...
    steps: [
      "Ask the team to imagine it is six months from now and they are proud of how they handled this period.",
      "Reflect on what the team is proud of, how people treated each other, what they learned, and which habits helped them succeed.",
      "Explore what employees would say about the team's leadership.",
      "Translate the future story into two or three concrete behaviors for today.",
    ],
    facilitation: ["Let people build a vivid and specific story before moving to actions.", "Look for behaviors the team can observe and practice, not broad aspirations.", "End with clear ownership for the chosen commitments."],
  ...
  },
  {
    ...
    unlocks: ["An Office Collaboration Agreement", "Shared reasons for working face to face", "Better balance between collaboration, energy, and focus"],
    useWhen: ["Hybrid or office routines need a reset", "People come to the office but spend the day in separate calls", "The team needs a safe conversation about energy and expectations"],
    steps: ["Explore what should be better when the team is together in person.", "Identify activities that are genuinely worth doing face to face.", "Discuss which behaviors give energy and which drain it.", "Create a short Office Collaboration Agreement covering collaboration, focus time, social connection, and energy check-ins."],
    facilitation: ["Focus the discussion on making office time useful rather than debating the policy itself.", "Protect individual focus needs as well as collaboration needs.", "Revisit the agreement after the team has tested it in practice."],
    goodFor: ["office", "hybrid", "collaboration", "team agreements", "energy", "focus", "social connection"],
    questions: ["What should be better when we are together?", "What activities are worth doing face to face?", "What behaviors give energy?", "What behaviors drain energy?", "What team agreements do we need?"],
    quote: "What should be better when we are together?",
  ...
  {
    id: "from-concern-to-influence",
    title: "From Concern to Influence",
    sourceId: "scania",
    lensId: "empathy-intent",
    time: "45-60 min",
    summary: "Help the team move from frustration and powerlessness toward influence and practical action.",
    signal: "Best when policy, change, or uncertainty is consuming energy but the team still has room to act.",
    unlocks: ["A clear boundary between concern and influence", "A stronger sense of agency", "Small actions the team can take now"],
    useWhen: ["The team is stuck in recurring concerns", "Motivation is falling during uncertainty or change", "You need a practical next step without dismissing frustration"],
    steps: ["Create three columns: Concern, Influence, and Action.", "List the issues currently taking the team's attention and energy.", "For each concern, identify what the team can genuinely influence.", "Choose a small, concrete action and decide who will take it forward."],
    facilitation: ["Acknowledge frustration before shifting toward action.", "Do not imply that the team is responsible for issues outside its control.", "Keep actions concrete and connected to real influence."],
    goodFor: ["concern", "influence", "action", "agency", "change", "motivation", "clarity"],
    questions: ["What concerns are taking our energy?", "What can we influence?", "What action can we take now?"],
    quote: "What can we influence?",
  ...
  },
  {
    ...
    lensId: "psychological-safety",
    time: "30-45 min",
    summary: "Acknowledge a difficult reality while surfacing support needs, progress, and grounded reasons for hope.",
    signal: "Best when the team needs an honest check-in without getting stuck in negativity.",
    unlocks: ["Shared acknowledgement of the current reality", "Clarity about support the team needs", "Recognition of progress, pride, and hope"],
    useWhen: ["Change, uncertainty, fatigue, or loss is affecting the team", "People need to feel heard before moving into planning", "The team needs both realism and possibility"],
    steps: ["Introduce the check-in as a space for honesty, listening, and support.", "Give everyone time to reflect individually on the four questions.", "Share in pairs or small groups before gathering themes together.", "Close by acknowledging what cannot be solved today and clarifying one useful next step."],
    facilitation: ["Do not rush people toward optimism or immediately try to solve what they share.", "Keep personal sharing voluntary.", "Be explicit about what is known, what is still unknown, and what support is available."],
    goodFor: ["reality", "hope", "check-in", "psychological safety", "change", "support", "honesty"],
    questions: ["What has been hardest?", "What are you proud that we managed anyway?", "What clarity or support do you need?", "What is one thing that gives you hope?"],
    quote: "What is one thing that gives you hope?",
